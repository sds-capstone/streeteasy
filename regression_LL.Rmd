...
tree = rpart(price ~ bedrooms + bathrooms + size_sqft + time_to_subway + year_built, data = listings, subset = train, method = "class")
fancyRpartPlot(tree)
```

```{r prediction analysis}
tree_c = rpart(price ~ addr_city, data = listings, subset = train, method = "class")
...
```{r simple decision tree}
tree = rpart(price ~ bedrooms + bathrooms + size_sqft + time_to_subway + year_built + addr_lat + addr_lon, data = listings_adj, subset = train, method = "class")
fancyRpartPlot(tree)
```
